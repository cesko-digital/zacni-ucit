...
class UP2CoursesSpider(scrapy.Spider):
    name = "up2_courses"

    formdata = {
        "ajax": "czv_ajax_get_opened_programs",
        "faculty": "%",
        "type": "%",
        "name": "",
        "id": "0",
    ...
    list_url = "https://czv.upol.cz/czv_programs/opened_programs-0/"
    ...
    def parse(self, response):
            ...
            "rows": [
              {
                ...
                "type_of_evidence": "2",
                "cisloOboru": "R501W023",
                "nazev": "Aktuální témata Fyzické geografie České republiky I.",
                "fakulta": "PRF",
                "cert_type": "144"
              },
              ...
        ...
        for item in json["data"]:
            formdata = {"ajax": "czv_ajax_get_obor_info", "oborIdno": "3760", "stprIdno": "1498"}
