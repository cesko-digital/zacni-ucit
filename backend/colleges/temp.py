...
def init_courses_2021_01():
    ...
    COURSES = """
        ...
        Učitelství odborných předmětů	ČVUT, MUVS	Masarykův ústav vyšších studií	0 Kč	Praha	6	prezenční, kombinovaná	https://www.muvs.cvut.cz/zajemci-o-studium/bakalarske-studium/ucitelstvi-odbornych-predmetu/	ODBP																											Bc., pedagogické vědy, příprava učitelů 2. stupně ZŠ nebo SŠ	
        Učitelství praktického vyučování a odborného výcviku	ČVUT, MUVS	Masarykův ústav vyšších studií	0 Kč	Praha	6	kombinovaná	https://www.muvs.cvut.cz/zajemci-o-studium/bakalarske-studium/ucitelstvi-praktickeho-vyucovani-a-odborneho-vycviku/	PV	ODBV																										Bc., pedagogické vědy, příprava učitelů 2. stupně ZŠ nebo SŠ	
        Učitelství praktického vyučování	ČZU, IVP	Institut vzdělávání a poradenství	0 Kč	Praha	6	kombinovaná	https://www.ivp.czu.cz/cs/r-6930-studium/r-7469-studijni-programy/r-8775-programy-bakalarskeho-studia/r-8779-ucitelstvi-praktickeho-vyucovani	ODBP																											Bc., pedagogické vědy, příprava učitelů 2. stupně ZŠ nebo SŠ	
        ...
        Učitelství informatiky pro 2. stupeň ZŠ	JČU, PF	Pedagogická fakulta	38 000 Kč	České Budějovice	4	kombinovaná	https://www.pf.jcu.cz/education/department/czv/dvpp-it_zs.php	IKT																											doplňující studium k rozšíření odborné kvalifikace (DVPP)	
        ...
        Studium v oblasti pedagogických věd se zaměřením na přípravu učitelů odborných předmětů - UOP na SŠ - Pedagogické studium A	ZČU, FPe	Fakulta pedagogická	28 000 Kč	Plzeň	4	kombinovaná	https://www.pc.fpe.zcu.cz/kurz.php?k=33&c=18	ODBP																											?	
        Studium v oblasti pedagogických věd se zaměřením na přípravu učitelů praktického vyučování - UPV a odborného výcviku - UOV na SŠ - Pedagogické studium - B + C	ZČU, FPe	Fakulta pedagogická	28 000 Kč	Plzeň	4	kombinovaná	https://www.pc.fpe.zcu.cz/kurz.php?k=34&c=18	PV	ODBV																										?	
    ...
    for course in courses:
        try:
            ...
            breakpoint()
        price = int(course["Cena"].replace("Kč", "").replace("\xa0", "").strip())
        sds = int(course["SDS / semestr"].strip())
        form = [i.strip() for i in course["Forma studia"].strip().split(",")]

        for college_code in colleges:
            faculty = Faculty.objects.get(
                name=course["Fakulta"], college__code=college_code.strip(), town=course["Město"].strip()
            )
