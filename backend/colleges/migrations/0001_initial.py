    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('form_present', models.BooleanField(default=False, help_text='Prezenční forma studia')),
                ('form_combined', models.BooleanField(default=True, help_text='Kombinovaná forma studia')),
                ('form_distant', models.BooleanField(default=False, help_text='Distanční forma studia')),
                ('double_major', models.BooleanField(default=False, help_text='Dvouobor')),
                ('single_major', models.BooleanField(default=True, help_text='Jednoobor')),
