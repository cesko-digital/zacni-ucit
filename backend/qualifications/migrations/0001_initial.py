    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created', django_extensions.db.fields.CreationDateTimeField(auto_now_add=True, verbose_name='created')),
                ('modified', django_extensions.db.fields.ModificationDateTimeField(auto_now=True, verbose_name='modified')),
                ('name', models.CharField(max_length=200, null=True, verbose_name='Zákonná formulace')),
                ('name_edu_type', models.CharField(max_length=200, null=True, verbose_name='Název edu_type')),
                ('link_available', models.BooleanField(default=True)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('subject_groups', models.ManyToManyField(to='teaching.SubjectGroup', verbose_name='Skupiny předmětů')),
            ],
            options={
